...
Even if the Corona virus has not had a breakout outside of Mainland China and the cruises, it's still a very dangerous virus and can cause significia per country. The smallest spark can cause it grow exponentially in the first 10 days and by the first 20 days it may reach thousands if not tens of thousands in population. 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIxMzAzMzg2MzgsMTIzNTMzODkzMSwtMT
